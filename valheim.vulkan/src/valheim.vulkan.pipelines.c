...
void valheim_initPipelineManager(valheim_VulkanContext *context) {
	valheim_initArray(context->pipelineManager.pipelines, 1024, context->allocator);
	valheim_initArray(context->pipelineManager.pipelineLayouts, 1024, context->allocator);
	valheim_initArray(context->pipelineManager.destriptorSetLayouts, 1024, context->allocator);
	valheim_initArray(context->pipelineManager.freeList, 1024, context->allocator);
